...
const additional = "- **Backend Prepared:** The backend API routes for real telemetry are already written and mounted!\n  - : Provides the Server-Sent Events (SSE) stream for OS vitals and Inventory counts via .\n  - : Contains the deep PostgreSQL inspection endpoint .";
