...
export const paletteSurfaces: PaletteSurface[] = [
  ...
  ...views("/api-tokens", "Developer Hub", "tab", [
    ["tokens", "API Tokens & Rate Limits"],
    ["docs", "AI Gateway & Endpoint Docs"],
  ]),
  ...views("/reporting", "Reporting & FinOps", "tab", [
    ["overview", "Reporting Overview"],
    ["usage", "Token Usage & Runs"],
    ["cost", "FinOps & Cost Analytics"],
    ["operators", "Operator Analytics"],
    ["rag", "RAG Analytics & Retrieval"],
    ["invoicing", "Tenant Invoicing & Billing"],
    ["exports", "Scheduled Exports & Reports"],
  ]),
  ...
  ...views("/users", "Users & Tenants", "view", [
    ["users", "Users"],
    ["groups", "Groups"],
    ["tenants", "Tenant Organizations & SSO"],
    ["templates", "Templates"],
  ...
  ...views("/policy", "Policy & Security", "view", [
    ["vault", "Secret Vault (BYOK)"],
    ["genguard", "GenGuard AI Firewall"],
