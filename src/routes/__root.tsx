...
import { ConfirmHost } from "@/components/sovereign/confirm-dialog";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Elara Sovereign Studio" },
      {
        name: "description",
        content: "Enterprise control plane for orchestrating AI agents, models and workflows.",
      },
      { name: "author", content: "Elara Sovereign Studio" },
      { property: "og:title", content: "Elara Sovereign Studio" },
      {
